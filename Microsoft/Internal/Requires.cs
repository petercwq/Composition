...
namespace Microsoft.Internal
{
    internal static class Requires
    {
        ...
        public static void NotNullOrEmpty(string value, string parameterName)
        {
            ...
            if (value.Length == 0)
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, System.Composition.Properties.Resources.ArgumentException_EmptyString, parameterName), parameterName);
            }
            Contract.EndContractBlock();
        }
        ...
        //        {
        //            throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, System.Composition.Properties.Resources.ArgumentOutOfRange_InvalidEnumInSet, parameterName, value, enumFlagSet.ToString()), parameterName);
        //        }
        //        Contract.EndContractBlock();
        //    }
    }
