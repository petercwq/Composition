...
namespace System.Composition.TypedParts.Discovery
{
    class TypeInspector
    {
        ...
        static void CheckPropertyExportCompatibility(TypeInfo partType, PropertyInfo property, TypeInfo contractType)
        {
            ...
            {
                var message = string.Format(System.Composition.Properties.Resources.TypeInspector_ExportedContractTypeNotAssignable,
        ...
        static void CheckGenericContractCompatibility(TypeInfo partType, TypeInfo exportingMemberType, TypeInfo contractType)
        {
            ...
            {
                var message = string.Format(System.Composition.Properties.Resources.TypeInspector_NoExportNonGenericContract, partType.Name, contractType.Name);
                throw new CompositionFailedException(message);
            }
            ...
            foreach (var ifce in GetAssignableTypes(exportingMemberType))
            {
                if (ifce == contractType || (ifce.IsGenericType && ifce.GetGenericTypeDefinition() == contractType.AsType()))
                {
                    ...
                    {
                        var message = string.Format(System.Composition.Properties.Resources.TypeInspector_ArgumentMissmatch, contractType.Name, partType.Name);
                        throw new CompositionFailedException(message);
                    }
            ...
            if (!compatible)
            {
                var message = string.Format(System.Composition.Properties.Resources.TypeInspector_ExportNotCompatible, exportingMemberType.Name, partType.Name, contractType.Name);
                throw new CompositionFailedException(message);
            }
        }
        ...
        static void CheckInstanceExportCompatibility(TypeInfo partType, TypeInfo contractType)
        {
            ...
            {
                var message = string.Format(System.Composition.Properties.Resources.TypeInspector_ContractNotAssignable, contractType.Name, partType.Name);
                throw new CompositionFailedException(message);
            }
        }
    }
